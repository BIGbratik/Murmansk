...
function showNaslPunkt()
{
  ...
  var data = google.visualization.arrayToDataTable([
    ['Название населённого пункта', 'Население, чел.'],
    ['Первомайский округ', 118511],
    ['Октябрьский округ', 92183],
    ['Ленинский округ', 88454]
  ]);

  var options = {
    title: 'Населённые пункты по соотношению населения (кол-во чел.)',
    legend: { position: 'top' },
    is3D:true
  };
